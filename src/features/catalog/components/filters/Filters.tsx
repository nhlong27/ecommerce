...
const Filters = () => {
  ...
  return (
    <div className='w-full lg:p-6 py-3 sticky z-20 bg-white dark:bg-slate-800 rounded-md top-12 md:top-16 flex gap-8 shadow-md items-center'>
      ...
      <div className='hidden hover:bg-gray-100 dark:hover:bg-gray-900 lg:block rounded-md border px-4 py-3 font-mono text-sm ml-auto'>
        <ReviewFilter />
      </div>
      ...
      <Collapsible
        ...
        className='w-2/3 space-y-2 block lg:hidden mx-auto'
      >
