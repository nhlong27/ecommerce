export const ChevronRight = ({ size, className }: { size?: number; className?: string }) => (
  <svg
...
export const ChevronsUpDown = ({ size, className }: { size?: number; className?: string }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width='24'
    height='24'
...
export const BellRing = ({ size, className }: { size?: number; className?: string }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width='24'
    height='24'
...
export const Moon = ({ size, className }: { size?: number; className?: string }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size ?? 20}
    height={size ?? 20}
...
export const Sun = ({ size, className }: { size?: number; className?: string }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size ?? 20}
    height={size ?? 20}
...
export const Paperclip = ({ size, className }: { size?: number; className?: string }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size ?? 20}
    height={size ?? 20}
...
export const Search = ({ size, className }: { size?: number; className?: string }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size ?? 20}
    height={size ?? 20}
...
export const X = ({ size, className }: { size?: number; className?: string }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size ?? 20}
    height={size ?? 20}
...
export const Check = ({ size, className }: { size?: number; className?: string }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size ?? 20}
    height={size ?? 20}
...
export const Circle = ({ size, className }: { size?: number; className?: string }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width={size ?? 20}
    height={size ?? 20}
