...
export default function Promo() {
  return (
    <div className='w-full px-0 md:px-16 pt-4 pb-12 bg-gradient-to-b from-white via-blue-50 to-white dark:bg-none'>
      ...
      <div className='flex flex-col gap-8 md:gap-16 md:flex-row w-full divide-x-[1px] justify-center px-8'>
        <div className='w-11/12 mx-auto md:mx-0 md:w-3/5 flex shadow-lg rounded-md overflow-hidden bg-white  dark:bg-transparent'>
        ...
        <div className='w-11/12 mx-auto md:mx-0 md:w-3/5 flex overflow-hidden shadow-lg rounded-md bg-white dark:bg-transparent'>
          <div className='h-[18rem] w-[12rem] relative overflow-hidden'>
            <Image
